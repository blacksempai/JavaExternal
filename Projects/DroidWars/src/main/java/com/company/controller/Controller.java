            ...
            do {
                authorizationView.sendMsg(resourceBundle.getString(authorizationView.GREETINGS_MSG));
                    ...
                    switch (userInput) {
                        ...
                        default: {
                            logger.error(resourceBundle.getString(authorizationView.INVALID_MSG));
                            break;
                        }
    ...
    private void registerUser() {
        ...
        do {
            ...
            try {
                ...
                logger.error(resourceBundle.getString(authorizationView.REGISTRATION_FAILED_MSG));
        ...
        do {
            ...
            try {
                if (user.deserialize()==null) {
                    accountExist = true;
                    logger.error(resourceBundle.getString(authorizationView.NO_SUCH_ACCOUNT_MSG));
                } else {
